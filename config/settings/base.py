"""
Base settings for AIESEC_HRIS project.
...
ROOT_DIR = environ.Path(__file__) - 3  # (aiesec_hris/config/settings/base.py - 3 = aiesec_hris/)
APPS_DIR = ROOT_DIR.path('aiesec_hris')
...
LOCAL_APPS = [
    # custom users app
    'aiesec_hris.users.apps.UsersConfig',
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'aiesec_hris.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Ali Soliman""", 'ali.soliman@aiesec.org.eg'),
]
...
ACCOUNT_ADAPTER = 'aiesec_hris.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'aiesec_hris.users.adapters.SocialAccountAdapter'
