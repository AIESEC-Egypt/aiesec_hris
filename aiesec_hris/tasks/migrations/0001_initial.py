# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-12-25 23:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, 'NEW'), (2, 'SUBMITTED'), (3, 'ACCEPTED'), (4, 'REJECTED')], default=1)),
                ('submission_type', models.IntegerField(choices=[(1, 'TEXTUAL'), (2, 'NUMERIC')], default=1)),
